...
<head>
    ...
    <link href="{{asset('css/404error/404.css') }}" rel="stylesheet">
	<script type="text/javascript" src="{{asset('css/404error/404.js') }}" defer></script>
	...
	<main>
		<div class="container">
		  <div class="row">
			...
			<div class="col-md-6 align-self-center">
			  <h1>404</h1>
			  <h2>Oops! Estás perdido.</h2>
			  <p>La página que estás buscando no existe.
				Es un mistero el cómo llegaste aquí. Pero puedes hacer clic en el siguiente
				botón para ir a la página de inicio.
			  </p>
			  <a class="btn green" href="{{route('aHome')}}">Inicio</a>
			</div>
		  </div>
		</div>
	  </main>
